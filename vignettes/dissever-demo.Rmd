...
author: "Malone, B. and Roudier, P. and Martins, B. and Monteiro, J."
date: "`r Sys.Date()`"
...
Our examples use the dissever library, which automatically checks for the availability of other libraries that may be used:
...
In this section, we will dissever the sample datasetwith the available environmental covariates, using 6 different learning methods: 
